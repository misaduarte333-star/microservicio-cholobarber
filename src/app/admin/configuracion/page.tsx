 ...
 * Permite editar los datos generales (nombre, dirección, teléfono, redes sociales)
 * y establecer los horarios de apertura por día.
 */
export default function ConfiguracionPage() {
    ...
    /**
     * Carga la configuración actual de la sucursal desde la base de datos.
     * Si falla o no existe, carga datos de demostración.
     */
    const cargarConfiguracion = useCallback(async () => {
        ...
        try {
            ...
            if (error) {
                ...
                // Solo mostrar demo si realmente no hay datos y es error 406 (no filas)
    ...
    return (
        ...
        <>
            <div className="mb-8">
                ...
                <p className="text-muted-foreground mt-1">Administra los datos generales de la sucursal</p>
            </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="glass-card p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-muted mb-2">Google Maps URL</label>
                                <input
                                    type="url"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground/70 mt-1">Formato internacional sin espacios (ej. 521...)</p>
                                </div>

                                <div>
                                    <label className="block text-sm font-medium text-muted mb-2">Teléfono Fijo</label>
                                    <input
                                        type="tel"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-sm font-medium text-muted mb-2">Email de Contacto</label>
                                    <input
                                        type="email"
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-muted mb-2">Instagram URL</label>
                                    <input
                                        type="url"
